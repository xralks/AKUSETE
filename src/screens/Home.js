    ...
    <div className="App">
        ...
        <div style={styles.ancho}>
          <div style={styles.textContainer}>
            <div style={styles.textoinfo}>
              ...
              AKUSETE es una plataforma web innovadora diseñada para mejorar la seguridad y el 
              bienestar en instituciones educativas, comenzando por la Universidad Bernardo O’Higgins.
               Nuestro objetivo es proporcionar un entorno más seguro tanto para los estudiantes como
                para el personal, a través de herramientas y protocolos eficaces que respondan a 
      ...
      <section style={styles.section}>
        ...
        <img src={ticketerror} className="icono-logo" alt="logo" />
          ...
          <p>Evitar la creación de tickets falsos es crucial para mantener la confianza en el sistema.
             Esta práctica puede alertar a los encargados y generar respuestas innecesarias. Además,
              puede tener repercusiones legales y afectar la reputación del sitio web.</p>
        </div>
        <div className='itemaviso'>
        <img src={informal} className="icono-logo" alt="logo" />
          <h1>Informalidad y groserias</h1>
          <p>El uso de lenguaje informal y grosero puede perjudicar la comunicación y el ambiente laboral.
             Mantener un tono respetuoso es clave para fomentar el respeto y la colaboración, evitando ofensas y malentendidos.</p>
        </div>
        <div className='itemaviso'>
        <img src={sos} className="icono-logo" alt="logo" />
          <h1>Solo para emergencias</h1>
          <p>Es esencial utilizar el sitio web designado "solo para emergencias" deben usarse con responsabilidad.
             Su uso inapropiado puede comprometer la respuesta ante situaciones críticas y acarrear sanciones. 
             Evalúa siempre la necesidad antes de recurrir a ellos.</p>
        </div>
        </div>
      </section>
      <Footer />
